      ...
      sidebarLayout(
        ...
        sidebarPanel(
          ...
          textAreaInput(
            ...
            rows = 5,
            width = "100%",
            placeholder = "Optional: overall tone, emphasis, de-emphasis, specific changes, or job-specific positioning."
          ),

          textAreaInput(
            "role_context",
            "Role bullet guidance",
            value = "",
            rows = 5,
            width = "100%",
            placeholder = "Optional: instructions for the work experience bullets, such as which roles, outcomes, tools, or angles to emphasize."
          ),

          textAreaInput(
            "skills_context",
            "Skills stack guidance",
            value = "",
            rows = 5,
            width = "100%",
            placeholder = "Optional: instructions for the skills stack section, such as which categories, tools, or seniority calibration to prioritize."
          ),
