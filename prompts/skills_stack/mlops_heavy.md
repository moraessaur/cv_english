...
- Avoid vague phrases like:
  ...
  - "cloud workflows"
  - "modern ML systems"
  unless accompanied by actual technologies.
- Prefer:
  - PySpark instead of distributed processing
  - LightGBM instead of tree-based models
  - Athena instead of query service
  - Kubeflow instead of ML orchestration platform
